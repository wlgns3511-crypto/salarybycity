...
export default async function GuidePage({ params }: Props) {
  ...
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <TrustBlock sources={[{name:"BLS OEWS",url:"https://www.bls.gov/oes/"},{name:"Census ACS Income",url:"https://www.census.gov/topics/income-poverty/income.html"},{name:"BEA Personal Income",url:"https://www.bea.gov/data/income-saving/personal-income-by-state"}]} updated="BLS OEWS 2024, reviewed April 2026" />
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {others.map((g) => (
              <Link
                key={g.slug}
                href={`/guide/${g.slug}/`}
                className="block rounded-lg border border-slate-200 hover:border-blue-400 hover:bg-blue-50 p-4 transition-colors"
              >
