...
export const metadata: Metadata = {
  ...
  description: "Learn how SalaryDataPeek collects, processes, and verifies occupational wage statistics and employment data.",
};
  ...
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p className="lead text-lg text-slate-600">
        SalaryDataPeek is committed to providing accurate, comprehensive, and up-to-date data.
        This page explains how we collect, process, and verify our information.
      </p>

      <h2>Data Sources</h2>
      <p>
        Our data is sourced from authoritative, publicly available databases including: <strong>U.S. Bureau of Labor Statistics OES</strong>.
      ...
      <ul>
        <li><a href="https://www.bls.gov/data/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Bureau of Labor Statistics</a></li>
      </ul>
    </article>
  );
}
