...
export const metadata: Metadata = {
  title: "Disclaimer",
  description: "Disclaimer and limitations of liability for SalaryByCity.",
  ...
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p className="text-sm text-slate-500 mb-8">
        Last updated: <time dateTime={LEGAL_VINTAGES.disclaimer}>March 25, 2026</time>
      </p>

      <h2 className="text-xl font-semibold mt-8 mb-3">General Information</h2>
      <p>
        The information provided on SalaryByCity is for general informational and educational purposes only. While we
      ...
      <p>
        Data displayed on SalaryByCity is sourced from publicly available databases and third-party sources. While we
      ...
      <p>
        SalaryByCity displays third-party advertisements through Google AdSense and other ad networks. These advertisements
        are provided by third parties and do not imply endorsement by SalaryByCity. We are not responsible for the content
      ...
      <p>
        In no event shall SalaryByCity, its owners, operators, or contributors be liable for any direct, indirect,
