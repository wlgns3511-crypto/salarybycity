...
import { DB_UPDATED as DATA_VINTAGE } from "./authorship";
...
const PROFILE = {
  ...
  "entityLabel": "occupation and city wage profile",
  "detailSegment": "glossary",
  "source": "BLS OEWS, Census ACS, and BEA",
  "dataModule": "db",
  "dataFn": "getAllOccupations"
} as {
